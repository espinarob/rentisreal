...
export default class TenantMailing extends Component {
	...
	doProcessSending = ()=>{
      ...
      let tenantDetails = {
        Account  : this.props.doGetRentalDetails.tenantID,
        rentalID : this.props.doGetRentalDetails.requestID
      }
      let tenantName = String(this.props.doGetRentalDetails.firstName) + 
      ' ' + String(this.props.doGetRentalDetails.lastName);
      this.props.doOperateTenantMail(tenantName,
        this.props.doGetRentalDetails.Account,
        mail,
        finalDate,
        tenantDetails);
	    ...
	    return (
	    	<View style={{
              ...
              <Text style={{
              	...
              	Recipient: {this.props.doGetRentalDetails.propertyName}{', '}
                {this.props.doGetRentalDetails.propertyLocation}
              </Text>
